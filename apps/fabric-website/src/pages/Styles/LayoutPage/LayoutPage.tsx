    ...
    return (
      <div className={pageStyles.basePage}>
        ...
        <div className={pageStyles.u_maxTextWidth}>
          ...
          <p>
            Newer versions of Fabric require the <code>dir</code> attribute to be set to specify how the content should be rendered (whether
            left-to-right, <code>ltr</code>, or right-to-left, <code>rtl</code>
            ).
          </p>
        </div>
